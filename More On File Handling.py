...
with open("Tushar.txt") as t:
    print(t.readline()) #no need to close the file

"""
if we open a file outside with block and print readline() once and close it the file opened will print its first line if exists
"""