...
s = Employee("Shrishti", "Rawat")

print(t.email)
t.lname = "Mayer"
print(t.email) #Even after changing lname,email remained same because lname of object is same as that it was during object creation
